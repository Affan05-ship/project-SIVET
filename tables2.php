        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">RUANG 3.1</h1>
                    <p class="mb-4">tabel berikut memuat data-data dari inventarisasi ruang 3.1</p>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <a href="tambah2.php"<button type="button" class="btn btn-success mb-2"> + TAMBAH DATA</button></a>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    $data = mysqli_query($koneksi, "select * from inv31");
                                    $jumlah_data = mysqli_num_rows($data);
                                    $total_halaman = ceil($jumlah_data / $batas);

                                    $data_barang = mysqli_query($koneksi, "select * from inv31 limit $halaman_awal, $batas");
                                    $nomor = $halaman_awal + 1;
                                   
                                    if(isset($_GET['cari'])){
                                    $cari = $_GET['cari'];
                                    $data = mysqli_query($koneksi,"select * from inv31 where barang like '%".$cari."%'");    
                                    }else{
                                    $data = mysqli_query($koneksi,"select * from inv31");  
                                    }
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit2.php?id=<?php echo $d['id']; ?>"><button type="button" class="btn btn-warning">EDIT</button></a>
                                            <a href="hapus2.php?id=<?php echo $d['id']; ?>"><button type="button" class="btn btn-danger">HAPUS</button></a>
                                        </td>
                                    </tr>
                                     <?php    
                                     }

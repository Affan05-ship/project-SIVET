        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">RUANG 3.4</h1>
                    <p class="mb-4">tabel berikut memuat data-data dari inventarisasi ruang 3.4</p>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <a href="tambah5.php">+ TAMBAH DATA</a>
                                <table border="1">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    include 'koneksi.php';
                                    $no = 1;
                                    $data = mysqli_query($koneksi, "select * from inv34");
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit5.php?id=<?php echo $d['id']; ?>"><button type="button" class="btn btn-warning">EDIT</button></a>
                                            <a href="hapus5.php?id=<?php echo $d['id']; ?>"><button type="button" class="btn btn-danger">HAPUS</button></a>
                                        </td>
                                    </tr>
                                     <?php    
                                     }

        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">RUANG 3.2</h1>
                    <p class="mb-4">tabel berikut memuat data-data dari inventarisasi ruang 3.2</p>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <a href="tambah3.php">+ TAMBAH DATA</a>
                                <table border="1">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    include 'koneksi.php';
                                    $no = 1;
                                    $data = mysqli_query($koneksi, "select * from inv32");
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit3.php?id=<?php echo $d['id']; ?>"><button type="button" class="btn btn-warning">EDIT</button></a>
                                            <a href="hapus3.php?id=<?php echo $d['id']; ?>"><button type="button" class="btn btn-danger">HAPUS</button></a>
                                        </td>
                                    </tr>
                                     <?php    
                                     }
